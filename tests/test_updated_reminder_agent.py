...
1. Capture MeetingAgendaGeneratorTool return value in agenda_result
2. Pass full agenda_result dictionary to MeetingNotificationTool
3. Include all required arguments for MeetingNotificationTool
4. Add logging before and after each tool usage
5. Only invoke MeetingNotificationTool if agenda_result["success"] is True
6. Maintain email sending behavior with agenda PDF
"""
